...
public class DeserializationClusterVariableLengthRaw<T, U>(bool isCanonical, bool isImmutable, ClassId cid, bool isRootUnit, SemVersion version)
    ...
    where U : struct
{
    ...
    public override void ReadFill(Snapshot snapshot)
        => ReadFillVariableLengthRaw<T, U>(snapshot, Entries);
}
