...
public class DeserializationClusterVariableLengthWithFillRef<T, U>(bool isCanonical, bool isImmutable, ClassId cid, bool isRootUnit, SemVersion version)
    ...
    where U : struct, IHasPropertySetters<U>
{
    ...
    public override void ReadFill(Snapshot snapshot)
        => ReadFillVariableLengthWithFillRef<T, U>(snapshot, Entries);
}
